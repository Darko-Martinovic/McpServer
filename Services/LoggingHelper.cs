...
public static class LoggingHelper
{
    ...
    /// </summary>
    public static void LogMcpToolStart(
        ILogger logger,
        string requestId,
        string toolName,
    ...
    )
    {
        ...
        logger.LogInformation(
            "[{RequestId}] MCP Tool '{ToolName}' called by client{Parameters}",
            requestId,
            toolName,
            paramString
        );
    ...
    /// </summary>
    public static void LogMcpToolSuccess(
        ILogger logger,
        string requestId,
        string toolName,
        int resultCount,
    ...
    {
        logger.LogInformation(
            "[{RequestId}] MCP Tool '{ToolName}' completed successfully. Returned {Count} results in {ElapsedMs}ms",
            requestId,
            toolName,
            resultCount,
            elapsedMs
    ...
    /// </summary>
    public static void LogDatabaseOperationStart(
        ILogger logger,
        string requestId,
        string operation,
        string sql,
    ...
    )
    {
        ...
        logger.LogInformation(
            "[{RequestId}] Executing SQL for {Operation}: {Sql}{Parameters}",
            requestId,
            operation,
            sql,
            paramString
    ...
    /// </summary>
    public static void LogDatabaseOperationSuccess(
        ILogger logger,
        string requestId,
        string operation,
        int resultCount,
    ...
    )
    {
        logger.LogError(
            ex,
            "[{RequestId}] Database error in {Operation}: {Message}",
            requestId,
            operation,
            ex.Message
        );
    ...
    /// </summary>
    public static void LogMcpToolError(
        ILogger logger,
        Exception ex,
        string requestId,
        string toolName
    )
    {
        logger.LogError(
            ex,
            "[{RequestId}] MCP Tool '{ToolName}' failed: {Message}",
            requestId,
            toolName,
            ex.Message
        );
    ...
    )
    {
        ...
        logger.LogWarning(
            "[{RequestId}] MCP Tool '{ToolName}' validation failed: {Error}{Parameters}",
            requestId,
            toolName,
            error,
            paramString
